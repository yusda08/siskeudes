...
<table class='main' border='1' repeat_header="1" cellspacing="0" width="100%">
        ...
        <td style="" width="50%">
            <table class='main' border='0' repeat_header="1" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="5%">:</td>
                    <td><?= tgl_indo($row_srt['tgl_surat']); ?></td>
                </tr>
                </thead>
            </table>
        </td>
        <td width="50%">
            <table class='main' border='0' repeat_header="1" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="5%">:</td>
                    <td><?= tgl_indo($row_srt['tgl_masuk']); ?></td>
                </tr>
                <tr>
                    <td>No Agenda</td>
                    <td>:</td>
        ...
        <td class="padding-10">
            <div style="min-height: 100px">
                ...
                <table>
                    <?php
                    $no = 1;
                    foreach ($getPenerimaSurat as $i => $item) {
                        echo "<tr>
                        <td>".$no++.".</td>
                        <td>{$item['penerima']}</td>
                    </tr> ";
    ...
    <tr class="border-all">
        <td class="padding-10 no-border-right">
            ...
            <table class='main' border='0' repeat_header="1" cellspacing="0" width="100%">
                <?php
                foreach ($getListDisposisi as $dis) {
                    $nama_pejabat = $dis['nama_jabatan'];
                    ?>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 0px; padding-top: 0px">
                            <textarea rows="4" disabled style="width: 400px"><?= $dis['isi_disposisi']; ?></textarea>

                        </td>
                    </tr>
                    <tr style="padding-top: 0px">
                        <td colspan="2" style="font-size: 10px">Tanggal Disposisi
                            : <?= Tgl_indo_angka($dis['tgl_disposisi']) . ' At : ' . $dis['jam_disposisi']; ?></td>
                    </tr>
                <?php } ?>
            </table>
        </td>
